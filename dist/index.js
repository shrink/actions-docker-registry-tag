...
const tags_1 = __webpack_require__(532);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const results = yield tags_1.addTags(image, tags);
...
function addTags(image, tags) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield Promise.all(tags.map(function (tag) {
            return __awaiter(this, void 0, void 0, function* () {
                const result = yield node_fetch_1.default(manifestUrl(image, tag), {
                    method: 'PUT',
                    headers,
                    body: targetManifest
                });
...
function manifestUrl(image, tag) {
